...
<body class="home">
    ...
    banner part starts
    <section class="hero bg-image" data-image-src="images/Punjabi-thali-WS.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>Choose it & Enjoy your meals! </h1>
                <h5 class="font-white space-xs">Find popular  dishes, and coupons</h5>
    ...
    <section class="popular">
        <div class="container">
            ...
            <div class="row">
                <?php
$sql = "SELECT * FROM `dishes` order by id desc LIMIT 3";
$res = mysqli_query($db,$sql) or die("Error");
while($row= mysqli_fetch_row($res))
{
    echo ' <div class="col-xs-12 col-sm-6 col-md-4 food-item">
    <div class="food-item-wrap">
        <div class="figure-wrap bg-image" data-image-src="uploadimages/'.$row[5].'">
        </div>
        <div class="content">
            <h5><a href="#">'.$row[2].'</a></h5>
            <div class="product-name">'.$row[3].'</div>
            <div class="price-btn-block"> <span class="price">'.$row[4].'</span> </div>
        </div>
    </div>
</div>';
}
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                    <div class="food-item-wrap">
                        <div class="figure-wrap bg-image" data-image-src="images/6235ee0246746.jpg">
                            <div class="distance"><i class="fa fa-pin"></i>5 km</div>
                            <div class="rating pull-left"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                    class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i>
                            </div>
                            <div class="review pull-right"><a href="#">198 reviews</a> </div>
                        </div>
                        <div class="content">
                            <h5><a href="#">Chicken Burger</a></h5>
                            <div class="product-name">Lorem Ipsum is simply dummy text of the printing and typesetting
                                industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,
                                when an unknown printer took a galley of type and scrambled it to make a type specimen
                                book.</div>
                            <div class="price-btn-block"> <span class="price">150.00</span> <a
                                    href="#" class="btn theme-btn-dash pull-right">Order
                                    Now</a> </div>
                        </div>
                    </div>
                </div>
